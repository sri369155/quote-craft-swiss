                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {quotations.slice(0, 5).map((quotation) => (
                      <tr key={quotation.id} className="border-b hover:bg-[hsl(var(--thick-blue))]/10 hover:text-yellow-600 cursor-pointer transition-colors" onClick={() => navigate('/quotations')}>
