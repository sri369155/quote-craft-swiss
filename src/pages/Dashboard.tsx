...
import { Plus, FileText, Users, TrendingUp, LogOut, Upload, IndianRupee } from 'lucide-react'
          ...
          <div className="flex items-center justify-between h-16 bg-primary px-4 rounded-lg -mx-4">
            <div className="flex items-center space-x-8">
              <div className="flex items-center space-x-3">
                ...
                <span className="font-bookman font-bold text-2xl tracking-tight text-green-700 animate-flash-slow">Laabh AI</span>
              </div>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {quotations.slice(0, 5).map((quotation) => (
                      <tr key={quotation.id} className="border-b hover:bg-[#1E52F1] cursor-pointer transition-colors [&:hover_td]:!text-[#FFFF00]" onClick={() => navigate('/quotations')}>
