          ...
          <div className="flex items-center space-x-2 mb-6">
            <div className="relative flex-1">
              ...
              <Input
                ...
                className="pl-10 !bg-[#ffe6e6] border-2 border-[#3333ff]"
              />
            </div>
          </div>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredInvoices.map((invoice) => (
                    <TableRow key={invoice.id} className="hover:bg-[#1E52F1] cursor-pointer transition-colors [&:hover_td]:!text-[#FFFF00]">
